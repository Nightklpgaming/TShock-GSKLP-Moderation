        ...
        public static Dictionary<int, string> GetIllegalItem()
        {
            ...
            if (!Main.hardMode)
            {
                ...
                int[] addin = { 400, 401, 402, 403, 404, 406, 408, 409, 412, 415, 416, 417, 420,
                    ...
                    1171, 1181, 1244, 1247, 1253, 1264, 1265, 1306, 1308, 1311, 1312, 1314,
            ...
            if (!NPC.downedMechBoss1 && !NPC.downedMechBoss2 && !NPC.downedMechBoss3)
            {
                ...
                int[] templeids = { 497, 900, 1311, 1520, 5236, 5239, 5260, 5261, 5262 };
            ...
            if (!NPC.downedPlantBoss)
            {
                ...
                int[] addin = { 679, 757, 758, 759, 760, 771, 772, 773, 774, 786, 788, 823, 937, 938,
                    ...
                    4934, 4941, 4942, 4943, 4944, 4945, 4961, 4964, 4985, 5065, 5223, 5227, 5237,
                    5288, 5291, 5292, 5344, 5345, 5451, 5452 };
