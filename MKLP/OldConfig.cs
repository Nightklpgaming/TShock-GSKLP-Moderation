...
namespace MKLP
{
    ...
    {
        public OldConfig.CONFIG_HELPTEXT Guide;
        public OldConfig.CONFIG_MAIN Main; //x
        public OldConfig.CONFIG_CHATMODERATION ChatMod; //x
        public OldConfig.CONFIG_MANAGEPACKET ManagePackets; //x
        public OldConfig.CONFIG_PROGRESSION Progression; // x
        public Config.CONFIG_PERMISSIONS Permissions;
        public Config.CONFIG_DISCORD Discord;
        public Config.CONFIG_BOSSES BossManager;
        public Config.CONFIG_DATABASE DataBaseMain;
        public Config.CONFIG_DATABASE_LINKING DataBaseDLink;
        public Config.CONFIG_BanGuard BanGuard;
        public Config.CONFIG_UNRELEASE_FEATURE Unrelease;

        public static string path = Path.Combine(TShock.SavePath, "MKLP.json");

        public static OldConfig Read()
        {
            if (!File.Exists(path))
            {
            ...
            var args = JsonConvert.DeserializeObject<OldConfig>(File.ReadAllText(path));
        ...
        private static OldConfig Default()
        {
        ...
        public class CONFIG_MAIN
        {
            ...
            public Config.WhiteListAlt[]? WhiteList_User_JoinMatchUUID = { new Config.WhiteListAlt(AltNames: Variables.var1), new Config.WhiteListAlt(AltNames: Variables.var1) };
            ...
            public Config.CONFIG_COLOR_RBG? StaffChat_MessageRecieved_InGame_RBG = new();
